...
the_post();
 ...
 $input_below_text=get_post_meta(get_the_ID(),'input_below_text',true);
							...
							<div class="col-lg-7 animate-box">
								<form action="#" id="fh5co-subscribe">
									<div class="form-group">
										...
										<input type="submit" 
										value="<?php echo $button_label;?>" class="btn btn-primary">
										<p class="tip"><?php echo $input_below_text;?></p>
									</div>
								</form>
							</div>
						</div>
